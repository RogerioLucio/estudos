...
class Categoria_Model extends CI_Model {
	...
	public function getCategoriaQuantidade() {
		$sql = $this->db->query("SELECT DISTINCT categoria.id_categoria, categoria.descricao_categoria,count(equipamento.id_categoria) as quantidade
		from categoria JOIN equipamento on categoria.id_categoria = equipamento.id_categoria GROUP BY categoria.id_categoria");
		$query = $sql->result();
		return $query;
	}
